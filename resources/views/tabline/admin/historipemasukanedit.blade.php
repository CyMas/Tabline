    ...
    <div class="container body">
        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <form action="{{ url('histori/pemasukan/update') }}" method="POST">
                            <table class="table hovered" style="width: 100%">
                                ...
                                <tr>
                                    <td>Alamat</td><td>:</td>
                                    <td><div class="input-control text" data-role="datepicker">
                                            <textarea class="form-control" type="text" name="alamat" disabled>{{ $data->alamat }}</textarea>                                                    
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Jumlah Pemasukan</td><td>:</td>
                                    <td><div class="input-control text" data-role="datepicker">
                                            <input class="form-control" type="text" name="jumlah_pemasukan" value="{{ $data->jumlah_pemasukan }}" disabled>                                                    
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <a href="{{ url('histori/pemasukan/') }}"><div class="btn btn-default">Batal</div></a>
                            </form> 
                            </div>
                <!-- /top tiles -->
                <br />
